...
public class Circulo_05{
   private double raio;
   private Ponto2D_05 ponto;

   // atributos para definir o circulo
   public Circulo_05(double raio, Ponto2D_05 ponto) {
      this.raio = raio;
      this.ponto = new Ponto2D_05(ponto.getX(), ponto.getY());
   }
   
   // associacao por agregacao (ponto gerado fora do método)
   public boolean contains(Ponto2D_05 ponto) {
   ...
   public boolean contains(double x, double y) {
      return contains(new Ponto2D_05(x, y));
   }
