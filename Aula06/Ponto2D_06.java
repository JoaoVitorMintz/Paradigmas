...
public class Ponto2D_06 {
    ...
    public Ponto2D_06(double x, double y){
        this.x = x;
        this.y = y;
    }
    ...
    public Ponto2D_06 add(Ponto2D_06 outro){
        return new Ponto2D_06(this.x + outro.x, this.y+outro.y);
    }

    // Multiplicar ambas as coordenadas de um ponto 
    public Ponto2D_06 scale(double s){
        
        return new Ponto2D_06(this.x * s, this.y * s);

    }

    //Calcular o coeficiente angular de uma reta que passe pelos dois pontos
    public double gradient(Ponto2D_06 outro) {
    ...
    public double distEuclid(Ponto2D_06 outro){
